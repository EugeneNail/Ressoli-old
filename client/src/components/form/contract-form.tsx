  ...
  return (
    <form action="" className="form">
      ...
      <div className="form__input-group">
        ...
        />
        <Checkbox label="С учетом НДС" name="hasVat" onChange={setField} clearErrors={clearFieldErrors} />
        <Checkbox label="Есть ипотека" name="hasMortgage" onChange={setField} clearErrors={clearFieldErrors} />
      </div>
